...
namespace Wire.ValueSerializers
{
    public class Int32Serializer : ValueSerializer
    {
        ...
        {
            WriteValueImpl(ref writer, (int) value);
        }
        ...
        public static void WriteValue<TBufferWriter>(ref Writer<TBufferWriter> writer, int value)
        ...
        //the actual impls
        private static void WriteValueImpl<TBufferWriter>(ref Writer<TBufferWriter> writer, int value)
            where TBufferWriter : IBufferWriter<byte>
        {
            writer.Write(value);
        }
