...
namespace Wire.ValueSerializers
{
    public abstract class SessionAwareValueSerializer<TElementType> : ValueSerializer
    {
            ...
            Expression<Func<Func<Stream, DeserializerSession, TElementType>>> readStaticMethod)
        {
            ...
            var c = new IlCompiler<Action<Stream, object, SerializerSession>>(typeof(TElementType));
            ...
            var c2 = new IlCompiler<Func<Stream, DeserializerSession, TElementType>>(typeof(TElementType));
